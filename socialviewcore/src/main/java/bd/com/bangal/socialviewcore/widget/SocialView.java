package bd.com.bangal.socialviewcore.widget;
...
import bd.com.bangal.socialviewcore.internal.SocialViewHelper;
...
public interface SocialView {
  ...
  /**
   * Returns color instance of <b>hashtags</b>, default is color accent of current app theme. Will
   * still return corresponding color even when {@link #isHashtagEnabled()} is false.
   */
  @NonNull
  ColorStateList getHashtagColors();

  /**
   * Returns color instance of <b>mentions</b>, default is color accent of current app theme. Will
   * still return corresponding color even when {@link #isMentionEnabled()} ()} is false.
   */
  @NonNull
  ColorStateList getMentionColors();

  /**
   * Returns color instance of <b>hyperlinks</b>, default is color accent of current app theme. Will
   * still return corresponding color even when {@link #isHyperlinkEnabled()} ()} is false.
   */
  @NonNull
  ...
  /**
   * Interface definition for a callback to be invoked when a <b>hashtag</b>, <b>mention</b>, or
   * <b>hyperlink</b> is clicked.
   */
