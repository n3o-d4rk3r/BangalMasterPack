...
import bd.com.bangal.socialviewcore.widget.SocialView;
...
public class SocialAutoCompleteTextView extends AppCompatMultiAutoCompleteTextView
  ...
  /**
   * While `CommaTokenizer` tracks only comma symbol, `CharTokenizer` can track multiple characters,
   * in this instance, are hashtag and at symbol.
   *
